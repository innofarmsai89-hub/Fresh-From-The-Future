...
export default function HomePage() {
  return (
    <main className={`${spartan.variable} font-spartan w-full overflow-x-hidden bg-white`}>
     ...
     <section className="py-20 max-w-[1440px] mx-auto px-6 font-spartan">
  <div className="text-center mb-16">
    <h2 className="font-bold text-[48px] md:text-[64px] text-[#3D550C] mb-6">
  Why are we different?
</h2>
<p className="text-[24px] md:text-[32px] text-[#1E1E1E] font-medium leading-tight">
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
    {/* Card 1 */}
    <div className="bg-[#FFF9F1] border border-[#F9C06A]/40 rounded-[30px] p-8 flex flex-col items-center text-center h-[300px] justify-center transition-all duration-300 hover:brightness-95 hover:shadow-lg cursor-pointer">
      <div className="w-[80px] h-[80px] mb-5 relative">
        <Image src="/images/home/coffee-beans.png" alt="Non GMO" fill className="object-contain" />
      </div>
      <h3 className="font-bold text-[26px] text-[#3D550C] mb-3 leading-tight">Non GMO & <br />Pesticide Free</h3>
      <p className="text-[16px] text-[#1E1E1E] leading-relaxed">Only the best-quality seeds were sown, promising a rich harvest.</p>
    </div>
    ...
    <div className="bg-[#FFF9F1] border border-[#F9C06A]/40 rounded-[30px] p-8 flex flex-col items-center text-center h-[300px] justify-center transition-all duration-300 hover:brightness-95 hover:shadow-lg cursor-pointer">
      ...
      <h3 className="font-bold text-[26px] text-[#3D550C] mb-3 leading-tight">UAE & Singapore<br />Grade Farming</h3>
      <p className="text-[16px] text-[#1E1E1E] leading-relaxed">Used AI & IOT SAAS technology by award winning INNOFarms Platform</p>
    </div>
    ...
    <div className="bg-[#FFF9F1] border border-[#F9C06A]/40 rounded-[30px] p-8 flex flex-col items-center text-center h-[300px] justify-center transition-all duration-300 hover:brightness-95 hover:shadow-lg cursor-pointer">
      ...
      <h3 className="font-bold text-[26px] text-[#3D550C] mb-3 leading-tight">Hyper-Local</h3>
      <p className="text-[16px] text-[#1E1E1E] leading-relaxed">From harvest-to-kitchen in under 24 hours for unmatched freshness.</p>
    </div>
    ...
    <div className="bg-[#FFF9F1] border border-[#F9C06A]/40 rounded-[30px] p-8 flex flex-col items-center text-center h-[300px] justify-center transition-all duration-300 hover:brightness-95 hover:shadow-lg cursor-pointer">
      ...
      <h3 className="font-bold text-[26px] text-[#3D550C] mb-3 leading-tight">Consistent Quality</h3>
      <p className="text-[16px] text-[#1E1E1E] leading-relaxed">Uniform taste, texture, and appearance 365 days a year</p>
    </div>
  </div>
  ...
  <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
    {/* Card 5 */}
    <div className="bg-[#FFF9F1] border border-[#F9C06A]/40 rounded-[30px] p-8 flex flex-col items-center text-center h-[300px] justify-center transition-all duration-300 hover:brightness-95 hover:shadow-lg cursor-pointer">
      <div className="mb-5 w-[80px] h-[80px] relative">
        <Image src="/images/home/traceability.png" alt="Traceability" fill className="object-contain" />
      </div>
      <h3 className="font-bold text-[26px] text-[#3D550C] mb-3 leading-tight">Traceability</h3>
      <p className="text-[16px] text-[#1E1E1E] leading-relaxed">Full crop traceability from seed to harvest via QR code.</p>
    </div>
    ...
    <div className="bg-[#FFF9F1] border border-[#F9C06A]/40 rounded-[30px] p-8 flex flex-col items-center text-center h-[300px] justify-center transition-all duration-300 hover:brightness-95 hover:shadow-lg cursor-pointer">
      ...
      <h3 className="font-bold text-[26px] text-[#3D550C] mb-3 leading-tight">Custom Crop<br />Requests</h3>
      <p className="text-[16px] text-[#1E1E1E] leading-relaxed">Grown specifically to match your menu and seasonal needs.</p>
    </div>
    ...
    <div className="bg-[#FFF9F1] border border-[#F9C06A]/40 rounded-[30px] p-8 flex flex-col items-center text-center h-[300px] justify-center transition-all duration-300 hover:brightness-95 hover:shadow-lg cursor-pointer">
      ...
      <h3 className="font-bold text-[26px] text-[#3D550C] mb-3 leading-tight">No Middlemen</h3>
      <p className="text-[16px] text-[#1E1E1E] leading-relaxed">Direct from our controlled environment farm to your kitchen.</p>
    </div>
  </div>

  <div className="mt-16 text-center max-w-4xl mx-auto">
    <p className="text-[22px] text-[#1E1E1E] font-medium mb-2">Where technology meets taste, every leaf perfected.</p>
